//
//  ISUIntroductionViewController.m
...
@interface ISUIntroductionViewController ()

@end

@implementation ISUIntroductionViewController
...
- (void)showIntroWithCrossDissolve {
    ...
    page1.titleIconView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"original"]];
    ...
    page2.titleIconView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"supportcat"]];
    ...
    page3.titleIconView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"femalecodertocat"]];
