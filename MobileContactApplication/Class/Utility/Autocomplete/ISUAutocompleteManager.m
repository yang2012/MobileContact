...
@implementation ISUAutocompleteManager

+ (ISUAutocompleteManager *)sharedManager
{
    static ISUAutocompleteManager *sharedManager;
	static dispatch_once_t done;
	dispatch_once(&done, ^{ sharedManager = [[ISUAutocompleteManager alloc] init]; });
...
{
    if (textField.autocompleteType == ISUAutocompleteTypeEmail)
    {
