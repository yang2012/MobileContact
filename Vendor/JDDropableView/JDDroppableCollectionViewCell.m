...
@interface JDDroppableCollectionViewCell ()
...
@implementation JDDroppableCollectionViewCell
...
- (void)addDropTarget:(UIView*)target;
{
    ...
    // add target
    if ([target isKindOfClass:[UIView class]] && ![self.dropTargets containsObject:target]) {
